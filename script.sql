...
CREATE TABLE [Post] (
    ...
    CONSTRAINT [PK_Post_Author] FOREIGN KEY ([AuthorId]) REFERENCES [User] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [PK_Post_Category] FOREIGN KEY ([CategoryId]) REFERENCES [Category] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES (N'20240222234516_InitialCreation', N'6.0.0');
GO
